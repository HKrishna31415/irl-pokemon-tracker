...
export const STORE_ITEMS = [
  ...
  { id: 'move-tutor-access', name: 'Move Tutor Access', price: 4000, description: 'Unlocks specialized competitive moves not found in standard TMs.', type: 'service' },
  ...
  { id: 'heart-scale', name: 'Heart Scale', price: 1000, description: 'Used as move reminder currency.', type: 'item' },
